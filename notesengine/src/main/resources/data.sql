insert into author (id, name, password, role) values (null, 'android', '1111', 'USER');
insert into author (id, name, password, role) values (null, 'telegrambot1', 'sdfq', 'ADMIN');
insert into author (id, name, password, role) values (null, 'spa1', '1111', 'ADMIN');
...
insert into note (id, text, author_id, book_id) values (null, 'Съешь же ещё этих мягких французских булок да выпей чаю.', select id from author where name like '%android%', select id from book where name like '%local_notes%');
insert into note (id, text, author_id, book_id) values (null, 'The five boxing wizards jump quickly.', select id from author where name like '%android%', select id from book where name like '%local_notes%');
